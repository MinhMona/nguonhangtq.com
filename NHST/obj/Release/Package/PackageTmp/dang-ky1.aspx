<%@ Page Title="" Language="C#" MasterPageFile="~/PDVMasterNotLogin.Master" AutoEventWireup="true" CodeBehind="dang-ky1.aspx.cs" Inherits="NHST.dang_ky" %>
            ...
            <div class="services-content intro-align">
                <div class="intro-page">
                    <div class="breadcrumb clearfix">
                        <p>
                            <a href="/trang-chu" class="color-black">Trang chủ</a> - <span>Đăng ký</span>
                        </p>
                ...
                <div class="intro-page">
                    <div class="primary-form">
                        ...
                        <div class="form-row">
                            ...
                            <div class="clearfix"></div>
                            <span class="mar-top1" style="float: left; width: 100%;margin-top:10px;">Quý khách vui lòng bỏ số 0 ở đầu dãy số di động. VD: +84-91XXX</span>
                            <span class="error-info-show">
