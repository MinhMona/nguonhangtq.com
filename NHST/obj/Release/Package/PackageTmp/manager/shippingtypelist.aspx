<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="shippingtypelist.aspx.cs" Inherits="NHST.manager.shippingtypelist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <a type="button" class="btn primary-btn" href="/manager/addshippingtype.aspx">Thêm loại vận chuyển</a>
        <h1 class="page-title">Danh sách loại vận chuyển</h1>
            ...
            <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="ShippingTypeName" HeaderText="WareHouseName" HeaderStyle-Width="5%">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn primary-btn" href='/manager/editshippingtype.aspx?i=<%#Eval("ID") %>'>Sửa</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
