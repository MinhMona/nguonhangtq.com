<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="Warehouse-from-list.aspx.cs" Inherits="NHST.manager.Warehouse_from_list" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <a type="button" class="btn primary-btn" href="/manager/addwarehousefrom.aspx">Thêm kho đi</a>
        <h1 class="page-title">Danh sách kho đi</h1>
            ...
            <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="WareHouseName" HeaderText="WareHouseName" HeaderStyle-Width="5%">
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="10%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn primary-btn" href='/manager/editwarehousefrom.aspx?i=<%#Eval("ID") %>'>Sửa</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
