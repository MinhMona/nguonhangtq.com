<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="view-outstock-session.aspx.cs" Inherits="NHST.manager.view_outstock_session" %>
            ...
            <div class="grid-row">
                <div class="grid-col" id="main-col-wrap">
                    <div class="feat-row grid-row">
                        <div class="grid-col-45 grid-row-center" style="width: 45%">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Thanh toán phiên xuất kho <asp:Literal ID="ltrIDS" runat="server"></asp:Literal></h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtTotalPrice" CssClass="form-control has-validate" Enabled="false">
                                            </asp:TextBox>
                                        </div>
                                        <div class="form-row no-margin center-txt">
                                            <asp:Button ID="btnPayall" runat="server" Text="Thanh toán bằng số dư TK" CssClass="btn primary-btn"
                                                OnClick="btnPayall_Click" UseSubmitBehavior="false" />
                                            <asp:Button ID="btncreateuser" runat="server" Text="Thanh toán" CssClass="btn primary-btn" Visible="false"
                                                OnClick="btncreateuser_Click" UseSubmitBehavior="false" />
                                            <asp:Button ID="btnExportWarehouse" runat="server" Text="Xuất kho" CssClass="btn primary-btn"
                                                OnClick="btnExportWarehouse_Click" UseSubmitBehavior="false" />
                                            <a href="/manager/accountant-outstock-payment"  class="btn primary-btn">Trở về</a>
                                            <asp:Button ID="btnPrint" runat="server" Text="In phiếu" CssClass="btn primary-btn"
                        ...
                        <div class="grid-col-50 grid-row-center" style="width: 50%">
