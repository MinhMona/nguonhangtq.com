        ...
        <div class="cont900" data-css='{"margin-bottom": "20px"}'>
            <div class="pane-shadow filter-form">
                <div class="grid-row">
                    ...
                    <div class="grid-col-50">
                        Tổng sổ link đã mua hàng
                    </div>
                    <div class="grid-col-50">
                        <asp:Label ID="lblTotalLink" runat="server" Text="0"></asp:Label>
                    </div>
                </div>
            </div>
        </div>
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="5%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn btn-info btn-sm" target="_blank" href='/manager/OrderDetail.aspx?id=<%#Eval("MainOrderID") %>'>Chi tiết đơn</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
