<%@ Page  Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/manager/adminMaster.Master"  CodeBehind="Edit-Banner.aspx.cs" Inherits="NHST.manager.Edit_Banner" %>
                                ...
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtBannerLink" CssClass="form-control"></asp:TextBox>
                                        </div>
