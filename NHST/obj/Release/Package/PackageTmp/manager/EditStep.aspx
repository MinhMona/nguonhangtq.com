                            ...
                            <article class="pane-primary">
                                ...
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtClassIcon" CssClass="form-control"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-row marbot1">
                                            <label for="exampleInputEmail">
                                                Sắp xếp
                                                 <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="pPartnerIndex" SetFocusOnError="true"
