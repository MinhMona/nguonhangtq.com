<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="Customer-Benefits.aspx.cs" Inherits="NHST.manager.Customer_Benefits" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        <a type="button" class="btn primary-btn" href="/manager/Add-Customer-Benefit.aspx">Thêm Trang</a>
            ...
            <telerik:RadGrid runat="server" ID="gr" OnNeedDataSource="r_NeedDataSource" AutoGenerateColumns="False"
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="CustomerBenefitName" HeaderText="Tên quyền lợi" HeaderStyle-Width="5%">
                        </telerik:GridBoundColumn>
