<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="RequestRechargeCYN.aspx.cs" Inherits="NHST.manager.RequestRechargeCYN" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        ...
        <h1 class="page-title">Danh sách yêu cầu nạp tiền tệ</h1>
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn btn-info btn-sm" href='/manager/RechargeCYN.aspx?id=<%#Eval("ID") %>'>Xem</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
