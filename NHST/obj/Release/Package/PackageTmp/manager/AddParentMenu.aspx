<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="AddParentMenu.aspx.cs" Inherits="NHST.manager.AddParentMenu" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Tạo mới menu cha</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
