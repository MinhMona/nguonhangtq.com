<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="addshippingtype.aspx.cs" Inherits="NHST.manager.addshippingtype" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Tạo mới loại vận chuyển</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
