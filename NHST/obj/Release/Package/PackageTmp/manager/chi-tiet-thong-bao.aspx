<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="chi-tiet-thong-bao.aspx.cs" Inherits="NHST.manager.chi_tiet_thong_bao" %>
                                ...
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:TextBox runat="server" ID="txtNotiName" CssClass="form-control" Enabled="false"></asp:TextBox>
                                        </div>
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:CheckBox runat="server" ID="IsSentNotiAdmin" Checked="false" />
                                        </div>
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:CheckBox runat="server" ID="IsSentNotiUser" Checked="false" />
                                        </div>
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:CheckBox runat="server" ID="IsSentEmailAdmin" Checked="false" />
                                        </div>
                                        ...
                                        <div class="form-row marbot2">
                                            <asp:CheckBox runat="server" ID="IsSendEmailUser" Checked="false" />
                                        </div>
                                        ...
                                        <div class="form-row no-margin center-txt">
                                            <asp:Button runat="server" ID="btnSave" Text="Cập nhật" CssClass="btn primary-btn" ValidationGroup="n" OnClick="btnSave_Click" />
                                              <a href="/manager/thiet-lap-thong-bao.aspx" class="btn primary-btn">Trở về</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
