<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterNew.Master" AutoEventWireup="true" CodeBehind="rut-tien.aspx.cs" Inherits="NHST.rut_tien1" %>
                        ...
                        <article class="pane-primary">
                            ...
                            <div class="cont">
                                ...
                                <div class="inner">
                                    ...
                                    <div class="form-row marbot2">
                                        <asp:TextBox ID="txtBankNumber" runat="server" CssClass="form-control full-width" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                    </div>
                                     <div class="form-row marbot1">
                                        Ngân hàng:
                                    </div>
                                    <div class="form-row marbot2">
                                        <asp:TextBox ID="txtBankAddress" runat="server" CssClass="form-control full-width" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                    </div>
                                    ...
                                    <div class="form-row marbot2">
                                        <asp:TextBox ID="txtBeneficiary" runat="server" CssClass="form-control full-width" TextMode="MultiLine" Height="50px"></asp:TextBox>
                                    </div>
                                    <div class="form-row marbot1">
                                        Nội dung:
                                    </div>
                                ...
                                <div class="step-income">
                                    <table class="customer-table mar-top1 full-width normal-table">
                                        <tr>
                                            ...
                                            <th width="20%" style="text-align: center">Số tài khoản</th>
                                            <th width="20%" style="text-align: center">Ngân hàng</th>
                                            <th width="20%" style="text-align: center">Người hưởng</th>
