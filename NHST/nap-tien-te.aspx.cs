...
namespace NHST
{
    public partial class nap_tien_te : System.Web.UI.Page
    {
        ...
        public void pagingall(List<tbl_Withdraw> acs)
        {
            ...
            if (acs.Count > 0)
            {
                ...
                for (int i = FromRow; i < ToRow + 1; i++)
                {
                    ...
                    ltr.Text += "   <td>";
                    if (status == 1)
                        ltr.Text += "<a href=\"javascript:;\" class=\"pill-btn btn order-btn main-btn \" onclick=\"deleteTrade('" + item.ID + "')\">Hủy yêu cầu</a>";
                    ltr.Text += "   </td>";
                    ltr.Text += "</tr>";
                }
            }
