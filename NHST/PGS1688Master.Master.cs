...
namespace NHST
{
    public partial class PGS1688Master : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            {
                ltrLogin.Text += "<div class=\"auth-button\">";
                ltrLogin.Text += "  <a href=\"/dang-nhap\" class=\"mn-btn login-btn\">Đăng nhập</a>";
                ltrLogin.Text += "  <a href=\"/dang-ky\" class=\"mn-btn reg-btn\">Đăng ký</a>";
                ltrLogin.Text += "</div>";
            }
        }
    }
