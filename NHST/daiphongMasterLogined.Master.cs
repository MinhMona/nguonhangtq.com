...
namespace NHST
{
    public partial class daiphongMasterLogined : System.Web.UI.MasterPage
    {
        ...
        public void LoadData()
        {
            ...
            if (Session["userLoginSystem"] != null)
            {
                ...
                if (acc != null)
                {
                    ...
                    ltrLogin.Text += "<a class=\"contact-method__main user-login\" href=\"/thong-tin-nguoi-dung\">" + username + "</a> | ";
                    ltrLogin.Text += "<a class=\"contact-method__main\" href=\"/gio-hang\">Giỏ hàng (" + count + ")</a>";
            ...
            {
                ltrLogin.Text += "<a class=\"btn btn-1\" href=\"/dang-nhap\">Đăng nhập</a>";
                ltrLogin.Text += "<a class=\"btn btn-2\" href=\"/dang-ky\">Đăng ký</a>";
            }
