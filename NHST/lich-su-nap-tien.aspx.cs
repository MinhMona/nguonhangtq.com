...
namespace NHST
{
    public partial class lich_su_nap_tien1 : System.Web.UI.Page
    {
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            //var listhist = HistoryPayWalletController.GetFromDateTodate(Convert.ToDateTime(rFD.SelectedDate), Convert.ToDateTime(rTD.SelectedDate));
            ...
            {
                StrExport.Append("  <tr>");
                StrExport.Append("      <td style=\"mso-number-format:'\\@'\">" + string.Format("{0:dd/MM/yyyy HH:mm}", item.CreatedDate) + "</td>");
            ...
            string strFile = "lich-su-giao-dich.xls";
