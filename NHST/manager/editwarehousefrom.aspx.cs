...
{
    public partial class editwarehousefrom : System.Web.UI.Page
    {
        ...
        public void LoadData()
        {
            ...
            if (id > 0)
            {
                var news = WarehouseFromController.GetByID(id);
                if (news != null)
                {
                    ViewState["NID"] = id;
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            if (ac.RoleID == 0)
            {
                ...
                if (w != null)
                {
                    WarehouseFromController.Update(id, txtWareHouseName.Text, 0, txtAddress.Text, txtEmail.Text, txtPhone.Text,
