<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="kien-that-lac.aspx.cs" Inherits="NHST.manager.kien_that_lac" %>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <%--<a class="btn btn-info btn-sm" href='/Admin/SmallPackage-Detail.aspx?ID=<%#Eval("ID") %>'>Sửa</a>--%>
                                   <a class="btn primary-btn" href='/manager/SmallPackage-Detail.aspx?ID=<%#Eval("ID") %>'>Chi tiết</a>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
