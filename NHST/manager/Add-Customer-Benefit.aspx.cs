...
{
    public partial class Add_Customer_Benefit : System.Web.UI.Page
    {
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            var kq = CustomerBenefitsController.Insert(IMG, CustomerBenefitName, CustomerBenefitDescription, link, IsHidden, Position, Email);
            if (kq != null)
            {
