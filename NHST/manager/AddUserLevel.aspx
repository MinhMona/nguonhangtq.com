<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="AddUserLevel.aspx.cs" Inherits="NHST.manager.AddUserLevel" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Thêm mới cấp người dùng</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row no-margin center-txt">
                                            ...
                                            <a href="/manager/User-Level.aspx" class="btn btn-success">Trở về</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
