<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="editwarehousefrom.aspx.cs" Inherits="NHST.manager.editwarehousefrom" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Chỉnh sửa kho đi</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
