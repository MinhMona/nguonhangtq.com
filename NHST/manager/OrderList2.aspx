<%@ Page Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="OrderList2.aspx.cs" Inherits="NHST.manager.OrderList2" %>
            ...
            <div class="pane-shadow filter-form" id="filter-form" style="display: block">
                <div class="grid-row">
                    <div class="grid-col-50">
                        <div class="lb">Tìm theo</div>
                        <div class="control-with-suffix">
                            <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control">

                                <asp:ListItem Value="5" Text="ID đơn hàng"></asp:ListItem>

                                <asp:ListItem Value="4" Text="UserName khách hàng"></asp:ListItem>

                                <asp:ListItem Value="2" Text="Mã vận đơn"></asp:ListItem>
                                <asp:ListItem Value="3" Text="Mã đơn hàng"></asp:ListItem>

                                <asp:ListItem Value="1" Text="Tên sản phẩm"></asp:ListItem>
                            </asp:DropDownList>
