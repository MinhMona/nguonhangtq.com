<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="OrderListSetStaff.aspx.cs" Inherits="NHST.manager.OrderListSetStaff" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <main id="main-wrap">
        ...
        <div class="cont900" data-css='{"margin-bottom": "20px"}'>
                    ...
                    <div id="advance-search" data-css='{"display": "none"}'>
                        ...
                        <div class="grid-col-100" style="display:none">
                            ...
                            <%-- <select class="form-control" id="tag" multiple>
                                ...
                                <option value="bg-bronze" data-value="2">Chờ mua hàng</option>
                                <option value="bg-green" data-value="5">Chờ shop TQ phát hàng</option>
            ...
            <div class="pane-shadow filter-form" id="filter-form1" style="display: none">
                    ...
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                ...
                                <%--<a class="btn primary-btn" href='/manager/Pay-Order.aspx?id=<%#Eval("ID") %>' target="_blank">Thanh toán</a>--%>
                            </ItemTemplate>
                        </telerik:GridTemplateColumn>
                    </Columns>
    ...
    <telerik:RadScriptBlock ID="sc" runat="server">
        <script type="text/javascript">
            ...
            function updateDathang(obj) {
                var mID = obj.attr('data-mainorderid');
                var valueselect = obj.val();
                add_loading();
                $.ajax({
                    type: "POST",
                    url: "/manager/OrderListSetStaff.aspx/updatedathang",
                    data: "{dathangID:'" + valueselect + "',mID:'" + mID + "'}",
            ...
            function updateSaler(obj) {
                var mID = obj.attr('data-mainorderid');
                var valueselect = obj.val();
                add_loading();
                $.ajax({
                    type: "POST",
                    url: "/manager/OrderListSetStaff.aspx/updatesaler",
                    data: "{salerID:'" + valueselect + "',mID:'" + mID + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (msg) {
                        var ret = msg.d;
