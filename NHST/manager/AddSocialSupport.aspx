<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="AddSocialSupport.aspx.cs" Inherits="NHST.manager.AddSocialSupport" %>
                    ...
                    <div class="feat-row grid-row">
                        <div class="grid-col-50 grid-row-center">
                            <article class="pane-primary">
                                <div class="heading">
                                    <h3 class="lb">Thêm mạng xã hội</h3>
                                </div>
                                <div class="cont">
                                    <div class="inner">
                                        ...
                                        <div class="form-row no-margin center-txt">
                                            ...
                                            <a href="/manager/SocialSupportList.aspx" class="btn primary-btn">Trở về</a>
                                        </div>
                                    </div>
                                </div>
                            </article>
