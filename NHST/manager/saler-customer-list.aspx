<%@ Page Title="" Language="C#" MasterPageFile="~/manager/adminMaster.Master" AutoEventWireup="true" CodeBehind="saler-customer-list.aspx.cs" Inherits="NHST.manager.saler_customer_list" %>
                ...
                <MasterTableView CssClass="normal-table" DataKeyNames="ID">
                    <Columns>
                        ...
                        <telerik:GridTemplateColumn HeaderStyle-Width="20%" HeaderStyle-HorizontalAlign="Center"
                            ...
                            <ItemTemplate>
                                <a class="btn btn-info btn-sm" href='/manager/UserInfo.aspx?i=<%#Eval("ID") %>'>Xem</a>
                                  <a class="btn btn-info btn-sm" href='/manager/User-Transaction.aspx?i=<%#Eval("ID") %>'>Lịch sử giao dịch</a>
                                  <a class="btn btn-info btn-sm" href='/manager/user-order?uid=<%#Eval("ID") %>'>Danh sách đơn hàng</a>
                            </ItemTemplate>
