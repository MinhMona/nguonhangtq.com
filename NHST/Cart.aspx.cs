            ...
            if (oshop != null)
            {
                if (oshop.Count > 0)
                {
                    ...
                    foreach (var shop in oshop)
                    {
                        ...
                        html += "           <tr><td>Số lượng</td><td><strong>" + string.Format("{0:N0}", TotalProduct) + "</strong></td></tr>";
                    ...
                    ltr_total_pay.Text += " <div class=\"left\">";
                    ltr_total_pay.Text += "     <p class=\"final-total\">Tổng số lượng: <strong class=\"hl-txt\">" + string.Format("{0:N0}", countProduct) + "</strong><span class=\"hl-txt\"></span></p>";
